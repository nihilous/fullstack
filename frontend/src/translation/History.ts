export const HistoryTranslations = {
  ...
  SWE: {
    ...
    date: `Datum`,
    round: `Omgång`,
    delete_child_record: `Ta bort barninformation`,
    delete: `Ta bort`,
    cancel: `Avbryt`,
    no_record: `Ingen post`,
    agree_to_delete: `Godkänd`,
    type: `Skriv texten till höger: `,
    new_date: `Nytt datum`,
    update: `Uppdatera`,
    update_child_record: `Uppdatera barninformation`,
    update_child_inst: `Vänligen fyll endast i nödvändiga fält.`,
    delete_history_record: `Ta bort vaccinationshistorik`,
    child_name: `Namn`,
