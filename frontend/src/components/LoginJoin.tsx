            ...
            >
              <Grid size={6} onClick={() => navigate('/main')} style={Marginer}>
                <Item>
                  ...
                  <div style={FontArea}>{translations.main}</div>
                </Item>
              </Grid>
              <Grid
                size={6}
              ...
              >
                <Item>
                  ...
                  <div style={FontArea}>{translations.board}</div>
                </Item>
              </Grid>
              <Grid
                size={6}
              ...
              >
                <Item>
                  ...
                  <div style={FontArea}>{translations.about}</div>
                </Item>
              </Grid>
              <Grid
                size={6}
              ...
              >
                <Item>
                  ...
                  <div style={FontArea}>{translations.account}</div>
                </Item>
              </Grid>
              <Grid size={12} onClick={() => logout(navigate, dispatch, false)}>
                <Item>
                  ...
                  <div style={FontArea}>{translations.logout}</div>
                </Item>
              </Grid>
            </Grid>
          </Box>
