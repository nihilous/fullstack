        ...
        <>
            {
                notices.map((notice) => {
                    ...
                    const history = formatDate(notice.history_date !== null ? notice.history_date as string : "", language);

                    const min_exp = notice.expected_vaccine_minimum_recommend_date !== undefined ? formatDateWithoutT(notice.expected_vaccine_minimum_recommend_date, language) : null;
                    const max_exp = notice.expected_vaccine_maximum_recommend_date !== undefined ? formatDateWithoutT(notice.expected_vaccine_maximum_recommend_date, language) : null;
